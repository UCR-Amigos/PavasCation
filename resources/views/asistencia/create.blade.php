            ...
            <div class="space-y-6">
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div id="capilla-content" class="p-4 hidden">
                        ...
                        <div>
                            ...
                            <input type="number" name="chapel_adultos_hombres" step="1" min="0" value="{{ old('chapel_adultos_hombres', 0) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" name="chapel_adultos_mujeres" step="1" min="0" value="{{ old('chapel_adultos_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Adultos Mayores Hombres</label>
                            <input type="number" name="chapel_adultos_mayores_hombres" step="1" min="0" value="{{ old('chapel_adultos_mayores_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Adultos Mayores Mujeres</label>
                            <input type="number" name="chapel_adultos_mayores_mujeres" step="1" min="0" value="{{ old('chapel_adultos_mayores_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Jóvenes Masculinos</label>
                            <input type="number" name="chapel_jovenes_masculinos" step="1" min="0" value="{{ old('chapel_jovenes_masculinos', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Jóvenes Femeninas</label>
                            <input type="number" name="chapel_jovenes_femeninas" step="1" min="0" value="{{ old('chapel_jovenes_femeninas', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div id="clase01-content" class="p-4 hidden">
                        ...
                        <div>
                            ...
                            <input type="number" name="clase_0_1_hombres" step="1" min="0" value="{{ old('clase_0_1_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niñas</label>
                            <input type="number" name="clase_0_1_mujeres" step="1" min="0" value="{{ old('clase_0_1_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestros (H)</label>
                            <input type="number" name="clase_0_1_maestros_hombres" step="1" min="0" value="{{ old('clase_0_1_maestros_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestras (M)</label>
                            <input type="number" name="clase_0_1_maestros_mujeres" step="1" min="0" value="{{ old('clase_0_1_maestros_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        </div>
                    </div>
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div id="clase26-content" class="p-4 hidden">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niños</label>
                            <input type="number" name="clase_2_6_hombres" step="1" min="0" value="{{ old('clase_2_6_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niñas</label>
                            <input type="number" name="clase_2_6_mujeres" step="1" min="0" value="{{ old('clase_2_6_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestros (H)</label>
                            <input type="number" name="clase_2_6_maestros_hombres" step="1" min="0" value="{{ old('clase_2_6_maestros_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestras (M)</label>
                            <input type="number" name="clase_2_6_maestros_mujeres" step="1" min="0" value="{{ old('clase_2_6_maestros_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        </div>
                    </div>
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div id="clase78-content" class="p-4 hidden">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niños</label>
                            <input type="number" name="clase_7_8_hombres" step="1" min="0" value="{{ old('clase_7_8_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niñas</label>
                            <input type="number" name="clase_7_8_mujeres" step="1" min="0" value="{{ old('clase_7_8_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestros (H)</label>
                            <input type="number" name="clase_7_8_maestros_hombres" step="1" min="0" value="{{ old('clase_7_8_maestros_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestras (M)</label>
                            <input type="number" name="clase_7_8_maestros_mujeres" step="1" min="0" value="{{ old('clase_7_8_maestros_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        </div>
                    </div>
                ...
                <div class="border rounded-lg overflow-hidden">
                    ...
                    <div id="clase911-content" class="p-4 hidden">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niños</label>
                            <input type="number" name="clase_9_11_hombres" step="1" min="0" value="{{ old('clase_9_11_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Niñas</label>
                            <input type="number" name="clase_9_11_mujeres" step="1" min="0" value="{{ old('clase_9_11_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestros (H)</label>
                            <input type="number" name="clase_9_11_maestros_hombres" step="1" min="0" value="{{ old('clase_9_11_maestros_hombres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Maestras (M)</label>
                            <input type="number" name="clase_9_11_maestros_mujeres" step="1" min="0" value="{{ old('clase_9_11_maestros_mujeres', 0) }}" 
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 asistencia-input" required>
                        </div>
                        </div>
                    </div>
