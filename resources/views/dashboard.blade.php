                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-gradient">₡{{ number_format($totalesMes['total_general'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold bg-gradient-gemini-blue bg-clip-text text-transparent">₡{{ number_format($totalesMes['total_diezmo'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-green-600">₡{{ number_format($totalesMes['total_misiones'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-orange-600">₡{{ number_format($totalesMes['total_construccion'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">₡{{ number_format($totalesMes['total_suelto'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-orange-600">₡{{ number_format($totalesMes['total_seminario'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-pink-600">₡{{ number_format($totalesMes['total_campa'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-red-600">₡{{ number_format($totalesMes['total_prestamo'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-display font-bold text-teal-600">₡{{ number_format($totalesMes['total_micro'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
