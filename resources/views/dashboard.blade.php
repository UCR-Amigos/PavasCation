        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            ...
            <div class="stat-card delay-100">
                ...
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-gemini-purple rounded-2xl p-4 shadow-glow-purple">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-gradient break-words">₡{{ number_format($totalesMes['total_general'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-200">
                ...
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-gemini-blue rounded-2xl p-4 shadow-glow-blue">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold bg-gradient-gemini-blue bg-clip-text text-transparent break-words">₡{{ number_format($totalesMes['total_diezmo'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-300">
                ...
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-gemini-success rounded-2xl p-4 shadow-glass">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-green-600 break-words">₡{{ number_format($totalesMes['total_misiones'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-400">
                ...
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl p-4 shadow-glass">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-orange-600 break-words">₡{{ number_format($totalesMes['total_construccion'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-500">
                ...
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-4 shadow-glow-pink">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent break-words">₡{{ number_format($totalesMes['total_suelto'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-600">
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl p-4 shadow-glass">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-orange-600 break-words">₡{{ number_format($totalesMes['total_seminario'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-700">
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl p-4 shadow-glow-pink">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-pink-600 break-words">₡{{ number_format($totalesMes['total_campa'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-800">
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl p-4 shadow-glass">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-red-600 break-words">₡{{ number_format($totalesMes['total_prestamo'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card delay-900">
                <div class="flex items-center relative z-10">
                    <div class="flex-shrink-0 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl p-4 shadow-glow-blue">
                        <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-5 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-xl font-display font-bold text-teal-600 break-words">₡{{ number_format($totalesMes['total_micro'], 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
