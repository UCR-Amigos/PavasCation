    ...
    <div class="flex h-screen overflow-hidden relative z-10">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-blue-800 text-white transform transition-transform duration-300 ease-out -translate-x-full lg:translate-x-0 lg:static lg:inset-0 flex flex-col shadow-xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto scrollbar-primary">
                ...
                @if(Auth::user()->canAccessRecuento())
                <a href="{{ route('recuento.index') }}" class="nav-link group flex items-center px-4 py-3 rounded-lg transition-colors duration-200 {{ request()->routeIs('recuento.*') && !request()->routeIs('recuento-clases.*') ? 'bg-blue-700 text-white' : 'text-blue-100 hover:bg-blue-700/50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('recuento-clases.index') }}" class="nav-link group flex items-center px-4 py-3 rounded-lg transition-colors duration-200 {{ request()->routeIs('recuento-clases.*') ? 'bg-blue-700 text-white' : 'text-blue-100 hover:bg-blue-700/50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                    </svg>
                    <span class="font-medium">Recuento Clases</span>
                </a>
                @endif
