            ...
            <div class="p-4 border-t border-white/20 bg-white/5 backdrop-blur-sm">
                ...
                <div class="pt-4 border-t border-white/20">
                    ...
                    <div class="flex items-center justify-center gap-3">
                        <a href="https://www.instagram.com/ibbpavas/" target="_blank" rel="noopener noreferrer" class="group w-11 h-11 rounded-xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-glow-pink">
                        ...
                        <a href="https://www.facebook.com/iglesia.biblica.bautista.pavas" target="_blank" rel="noopener noreferrer" class="group w-11 h-11 rounded-xl bg-blue-600 flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-glow-blue">
                            <svg class="w-5 h-5 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div id="logoutOverlay" class="fixed inset-0 bg-gradient-gemini z-50 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-500">
            <div class="text-center">
                ...
                <div class="mb-8 floating">
                    <img src="{{ asset('images/Logo.png') }}" alt="IBBP" class="w-32 h-32 mx-auto drop-shadow-2xl">
                </div>
