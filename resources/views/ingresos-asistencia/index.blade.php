...
@section('title', 'IBBP - Ingresos y Asistencia')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="p-4 bg-purple-50 rounded-lg">
                ...
                <p class="text-xl font-bold text-purple-600">₡{{ number_format($categorias['pro-templo'], 0, ',', '.') }}</p>
            </div>
            ...
            <div class="p-4 bg-indigo-50 rounded-lg">
                ...
                <p class="text-xl font-bold text-indigo-600">₡{{ number_format($categorias['ofrenda_especial'], 0, ',', '.') }}</p>
            </div>
