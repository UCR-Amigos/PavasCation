                    ...
                    <div class="space-y-3" id="detallesContainer">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">₡</span>
                                    <input type="number" name="detalles[4][monto]" id="campa" step="0.01" min="0"
                                           value="{{ old('detalles.4.monto', $detallesPorCategoria->get('campa')->monto ?? 0) }}"
                                           class="w-full pl-7 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 detalle-monto">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">₡</span>
                                    <input type="number" name="detalles[5][monto]" id="prestamo" step="0.01" min="0"
                                           value="{{ old('detalles.5.monto', $detallesPorCategoria->get('prestamo')->monto ?? 0) }}"
                                           class="w-full pl-7 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 detalle-monto">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">₡</span>
                                    <input type="number" name="detalles[6][monto]" id="construccion" step="0.01" min="0"
                                           value="{{ old('detalles.6.monto', $detallesPorCategoria->get('construccion')->monto ?? 0) }}"
                                           class="w-full pl-7 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 detalle-monto">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">₡</span>
                                    <input type="number" name="detalles[7][monto]" id="micro" step="0.01" min="0"
                                           value="{{ old('detalles.7.monto', $detallesPorCategoria->get('micro')->monto ?? 0) }}"
                                           class="w-full pl-7 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 detalle-monto">
