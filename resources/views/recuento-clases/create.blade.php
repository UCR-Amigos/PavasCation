...
@section('title', 'Pavas - Agregar Sobre de Clase')
@section('page-title', 'Registrar Sobre de Clase')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('recuento-clases.store') }}" method="POST" id="sobreForm">
            @csrf
                    ...
                    <select name="clase_id" id="clase_id"
                        ...
                        @foreach($clases as $clase)
                            <option value="{{ $clase->id }}"
                                    {{ ($clasePreseleccionada && $clasePreseleccionada->id == $clase->id) || old('clase_id') == $clase->id ? 'selected' : '' }}
            ...
            <div class="mt-6 flex justify-end gap-3">
                <a href="{{ route('recuento-clases.index', ['culto_id' => $culto ? $culto->id : '', 'clase_id' => $clasePreseleccionada ? $clasePreseleccionada->id : '']) }}"
