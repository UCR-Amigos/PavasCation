...
class IngresosAsistenciaController extends Controller
{
    public function index()
    {
        ...
        $categorias = [
            ...
            'campamento' => $cultosSemanales->sum(fn($c) => $c->totales ? $c->totales->total_campamento : 0),
            'pro_templo' => $cultosSemanales->sum(fn($c) => $c->totales ? $c->totales->total_pro_templo : 0),
        ...
        if ($tipoReporte == 'culto') {
            foreach ($cultos as $culto) {
                ...
                if ($t) {
                    $registros[] = [
                        ...
                        'campamento' => $t->total_campamento ?? 0,
                        'pro_templo' => $t->total_pro_templo ?? 0,
                    ...
                    $registros[] = [
                        ...
                        'campamento' => $sumCat('campamento'),
                        'pro_templo' => $sumCat('pro_templo'),
                        'suelto' => $suelto,
                        'total' => $total,
                    ];
                }
            ...
            foreach ($semanas as $semana => $cultosSeamana) {
                $registros[] = [
                    ...
                    'campamento' => $cultosSeamana->sum('totales.total_campamento'),
                    'pro_templo' => $cultosSeamana->sum('totales.total_pro_templo'),
            ...
            foreach ($meses as $mes => $cultosMes) {
                ...
                $registros[] = [
                    ...
                    'campamento' => $cultosMes->sum('totales.total_campamento'),
                    'pro_templo' => $cultosMes->sum('totales.total_pro_templo'),
        ...
        if ($tipoReporte == 'culto') {
            foreach ($cultos as $culto) {
                ...
                $registros[] = [
                    ...
                    'campamento' => $sumCategorias($sobres, 'campamento'),
                    'pro_templo' => $sumCategorias($sobres, 'pro_templo'),
                    'suelto' => 0,
            ...
            foreach ($semanas as $semana => $cultosSemana) {
                ...
                $registros[] = [
                    ...
                    'campamento' => $sumCategorias($sobresSemana, 'campamento'),
                    'pro_templo' => $sumCategorias($sobresSemana, 'pro_templo'),
                    'suelto' => 0,
            ...
            foreach ($meses as $mes => $cultosMes) {
                ...
                $registros[] = [
                    ...
                    'campamento' => $sumCategorias($sobresMes, 'campamento'),
                    'pro_templo' => $sumCategorias($sobresMes, 'pro_templo'),
                    'suelto' => 0,
